...
export default function Footer(){
    return(
        <>
            <div className="bg-[#2D2E32] py-10 ">
                <div className="px-4 flex flex-col gap-4 lg:flex-row  text-center  justify-between items-center">
                        ...
                        <span>
                            ...
                            <a className='text-[#148bfb] dark:text-[#bb86fc]' href='https://github.com/silcro-123' target="_blank">Tuan Phuong</a>
                    ...
                    <div className='flex gap-2'>
                        <a href='https://github.com/silcro-123' target="_blank">
                        ...
                        <a href='https://www.linkedin.com/in/tuan-phuong-tran-701972255/' target="_blank">
                            <svg className="bg-white dark:bg-[#bb86fc] rounded-md p-1 " width="32px" height="32px" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
